...
class TaumadhiSquareFragment(private var placeDataDtoList: ArrayList<PlaceDataModel>) : Fragment() {

    private var onMapPinClicked: OnMapPinClickListener? = null
    private var taumadhiSquareDtoList = ArrayList<PlaceDataModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in 0 until placeDataDtoList.size) {
            ...
            if (placeDataDto.placeId == 2) {
                taumadhiSquareDtoList.add(placeDataDto)
            }
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        view.ivPlaceImage.setImageDrawable(resources.getDrawable(R.drawable.img_taumadhi))
        for (i in 0 until taumadhiSquareDtoList.size) {
            val data = taumadhiSquareDtoList[i]
        ...
        view.ivMapPin.setOnClickListener {
            onMapPinClicked!!.onClickedMapPin(27.671359, 85.429328)
        }
    }
