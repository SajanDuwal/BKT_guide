...
class KamalPokahriFragment(private var placeDataDtoList: ArrayList<PlaceDataModel>) : Fragment() {

    private var onMapPinClicked: OnMapPinClickListener? = null

    private var KamalPokhariDtoList = ArrayList<PlaceDataModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in 0 until placeDataDtoList.size) {
            ...
            if (placeDataDto.placeId == 6) {
                KamalPokhariDtoList.add(placeDataDto)
            }
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        view.ivPlaceImage.setImageDrawable(resources.getDrawable(R.drawable.img_kamalpokhari))
        for (i in 0 until KamalPokhariDtoList.size) {
            val data = KamalPokhariDtoList[i]
        ...
        view.ivMapPin.setOnClickListener {
            onMapPinClicked!!.onClickedMapPin(27.676866, 85.438387)
        }
    }
